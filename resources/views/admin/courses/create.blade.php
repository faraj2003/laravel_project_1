<x-app-layout>
    ...
    <form method="POST" action="{{ route('admin.courses.store') }}" enctype="multipart/form-data" class="space-y-6 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        @csrf
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <div class="bg-slate-900 rounded-2xl border border-slate-800 shadow-xl p-6 text-white sticky top-28">
                    ...
                    <div class="space-y-4">
                        ...
                        <button type="submit" class="w-full flex justify-center items-center gap-2 py-3.5 px-4 border border-transparent rounded-xl shadow-lg shadow-brand-500/20 text-sm font-black text-white bg-brand-600 hover:bg-brand-500 transition-all active:scale-95 uppercase tracking-widest">
                            Commit Record
                        </button>
                    </div>
                </div>
