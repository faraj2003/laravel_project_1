                ...
                <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="5" class="block w-full rounded-xl border-slate-200 px-4 py-3 text-slate-900 shadow-sm focus:border-brand-500 focus:ring-brand-500 sm:text-sm bg-slate-50 focus:bg-white transition-colors resize-none" placeholder="Detail the learning objectives and structural content...">{{ old('description') }}</textarea>
                    ...
                    <div class="space-y-4">
                        <label class="flex items-center gap-3 p-3 rounded-xl border border-slate-700 bg-slate-800 cursor-pointer hover:bg-slate-700/80 transition-colors">
                            ...
                            <div class="flex flex-col">
                                ...
                                <span class="text-xs text-slate-400">Make available in the catalog</span>
                            </div>
                        </label>
